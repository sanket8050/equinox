...
//                 className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-green-500 hover:bg-gray-50"
//               >
...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden flex items-center justify-center">
      ...
      {/* Floating orbs */}
      <div className="fixed top-20 left-20 w-64 h-64 bg-purple-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s' }} />
      <div className="fixed bottom-20 right-20 w-64 h-64 bg-blue-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '7s', animationDelay: '1s' }} />
      ...
      {/* Main content */}
      <div className="relative z-10 w-150  px-6 py-2">
        {/* Card */}
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <CheckCircle className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
                <input
                  id="confirmPassword"
                  name="confirmPassword"
                  type="password"
            ...
            <button
              ...
              disabled={isLoading}
              className="group relative w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl font-semibold overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed hover:from-purple-500 hover:to-blue-500 transition-all mt-6"
            >
